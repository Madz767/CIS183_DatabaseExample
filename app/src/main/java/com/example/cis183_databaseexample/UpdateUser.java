...
public class UpdateUser extends AppCompatActivity {
    ...
    private void buttonClickSetUp()
    {
        ...
        btn_j_back.setOnClickListener(new View.OnClickListener() {
            ...
            {
                //goes back to the welcome page without making any changes
        ...
        btn_j_update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                //goes back to the welcome page but updated the database for the given user
                //given the data entered into the EditTexts
                //1. is to get the data from the textBoxes
